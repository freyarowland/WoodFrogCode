...
# load pond data
# no coordinates included because of sensitive populations
# put "distance.mat.csv" has all of the distances between ponds
coords <- read.csv("pondinfo.csv", header = TRUE)
...
eggs_long <- complete(alldata2, Year=2000:2020,
                      fill = list(Avg.RASY.Count = NA))

# recast data from long to wide format
egg_wide2 <- reshape2::dcast(eggs_long, Pond.ID ~ Year, value.var="Avg.RASY.Count", mean, na.rm = TRUE)
...
connect_2000$Pond.ID <- coords$Pond.ID
connect_2001$Pond.ID <- coords$Pond.ID
connect_2002$Pond.ID <- coords$Pond.ID
connect_2003$Pond.ID <- coords$Pond.ID
connect_2004$Pond.ID <- coords$Pond.ID
connect_2005$Pond.ID <- coords$Pond.ID
connect_2006$Pond.ID <- coords$Pond.ID
connect_2007$Pond.ID <- coords$Pond.ID
connect_2008$Pond.ID <- coords$Pond.ID
connect_2009$Pond.ID <- coords$Pond.ID
connect_2010$Pond.ID <- coords$Pond.ID
connect_2011$Pond.ID <- coords$Pond.ID
connect_2012$Pond.ID <- coords$Pond.ID
connect_2013$Pond.ID <- coords$Pond.ID
connect_2014$Pond.ID <- coords$Pond.ID
connect_2015$Pond.ID <- coords$Pond.ID
connect_2016$Pond.ID <- coords$Pond.ID
connect_2017$Pond.ID <- coords$Pond.ID
connect_2018$Pond.ID <- coords$Pond.ID
connect_2019$Pond.ID <- coords$Pond.ID
connect_2020$Pond.ID <- coords$Pond.ID
...
dd_final <- reshape2::melt(dd20n, id.vars = "Pond.ID",
                 variable.name = "wYear",
                 value.name = "wDD")
head(dd_final)
